using System.Text;
using AuebaPizzaria.API.Data;
using AuebaPizzaria.API.Middleware;
using AuebaPizzaria.API.Models;
using AuebaPizzaria.API.Services.Implementations;
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "AuebaPizzaria v1");
